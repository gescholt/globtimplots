...
`plot_convergence_analysis` — degree sweep on the Camel function. Max and average pairwise distance between recovered critical points collapse once the polynomial captures all minima.

![CP spread vs polynomial degree](docs/src/assets/gallery_convergence_analysis.png)
