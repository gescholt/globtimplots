...
**Convergence analysis** — `plot_convergence_analysis` shows max/average pairwise distance between recovered critical points across polynomial degree:

![CP spread vs polynomial degree](assets/gallery_convergence_analysis.png)
